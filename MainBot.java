...
import Test.bot.utils.jdr.serialize;
...
public class MainBot {
    ...
    MainBot(String token) {
        try {
            ...
            persos = new serialize().retreive(); //Retreive already existing hashmap
            if (persos == null){persos = new dataBase();}
